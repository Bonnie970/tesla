...
flags.DEFINE_string('first_stage_ckpt_path', None, 'Path to pretrained ckpt files')
...
def main(_):
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options = gpu_options)) as sess:
        ...
        if not pretrained_model:
            ...
            saver2.restore(sess,tf.train.latest_checkpoint(FLAGS.fine_tune_ckpt_path))
        ...
        while epoch_num < max_epochs:
            while batch_num < batchs_per_epoch:
                ...
                if FLAGS.dataset_name == 'DAVIS':
                    ...
                    #images_batch = load_data_adobe_processed(batch_alpha_paths,batch_trimap_paths, batch_FG_paths,batch_BG_paths,batch_RGB_paths)
                ...
                if step%FLAGS.save_ckpt_steps == 0:
                    ...
                    print('saving model......')
                    saver2.save(sess,FLAGS.fine_tune_ckpt_path + '/model.ckpt',global_step = global_step, write_meta_graph = True)
